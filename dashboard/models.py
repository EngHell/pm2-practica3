...
class CustomUserManager(BaseUserManager):
    ...
    """
    def create_user(self, email, password, genre, major, **extra_fields):
        """
        ...
        user = self.model(email=email, genre=StudentGenre(pk=genre), major=Major(pk=major), **extra_fields)
        user.set_password(password)
        user.save()
        return user

    def create_superuser(self, email, password, genre, major, **extra_fields):
        """
        ...
        return self.create_user(email, password, genre, major, **extra_fields)
